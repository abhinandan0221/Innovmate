...
const TeamChatHeader: React.FC<TeamChatHeaderProps> = ({
  ...
  return (
    <div className="flex items-center gap-3 p-3 border-b">
      ...
      <Avatar
        className="h-10 w-10 bg-green-100 dark:bg-green-900/30 cursor-pointer"
        onClick={() => {
          if (project.id) {
      ...
      >
        <AvatarFallback className="bg-gradient-to-br from-green-500 to-indigo-700 text-white">
