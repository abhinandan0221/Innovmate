...
function VerifyEmailForm() {
  ...
  return (
    ...
    >
      <Card className="border-0 shadow-lg dark:shadow-md dark:shadow-green-900/10">
        <CardHeader className="space-y-1 text-center pb-0">
          <div className="relative w-full">
            <Link
              href="/"
              className="absolute left-0 top-0 inline-flex items-center text-muted-foreground hover:text-green-600 dark:hover:text-green-400 transition-colors"
            >
              <ArrowLeft className="h-4 w-4 mr-1" />
              <span className="text-sm font-medium">Home</span>
            </Link>
            <div className="h-12 w-12 rounded-full bg-green-600 dark:bg-green-600 flex items-center justify-center mx-auto">
          ...
          {isVerifying ? (
            <div className="text-center py-8">
              <div className="flex justify-center">
                <div className="animate-spin rounded-full h-10 w-10 border-t-2 border-b-2 border-green-600 dark:border-green-400"></div>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border border-input rounded-md text-sm shadow-sm placeholder-muted-foreground focus:outline-none focus:border-green-500 focus:ring-1 focus:ring-green-500"
                  />
                </div>
                ...
                <Button
                  ...
                  className="w-full bg-green-600 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-800 text-white"
                >
                  {isResending ? (
                    <>
            ...
            <div className="text-center py-6">
              ...
              <Button
                asChild
                variant="default"
                className="bg-green-600 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-800 text-white"
              >
            ...
            <div className="text-center py-6">
              <div className="bg-green-50 dark:bg-green-900/20 p-6 rounded-lg">
                ...
                <p className="text-green-700/80 dark:text-green-400/90 mb-4">
