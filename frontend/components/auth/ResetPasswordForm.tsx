            ...
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-2">
                  ...
                  >
                    <ShieldCheck className="h-4 w-4 mr-1.5 text-green-500 dark:text-green-400" />
                    New Password
                  </label>
                  <Input
                    id="password"
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-green-600 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-800 text-white font-medium py-2.5"
                >
                  {isLoading ? (
                    <>
