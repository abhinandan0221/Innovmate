        ...
        <CardContent className="pt-6">
          ...
          {registrationSuccess ? (
            <div className="text-center py-6">
              ...
              <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg text-sm mb-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                >
                  <UserIcon className="h-4 w-4 mr-1.5 text-green-500 dark:text-green-400" />
                  Full name
                </label>
                <Input
                  id="name"
              ...
              <div className="space-y-2">
                <label
                  ...
                  className="text-sm font-medium text-foreground flex items-center"
                >
                  <Mail className="h-4 w-4 mr-1.5 text-green-500 dark:text-green-400" />
                  Email address
                </label>
                <Input
                  id="email"
              ...
              <div className="space-y-2">
                <label
                  ...
                  className="text-sm font-medium text-foreground flex items-center"
                >
                  <Lock className="h-4 w-4 mr-1.5 text-green-500 dark:text-green-400" />
                  Password
                </label>
                <Input
                  id="password"
