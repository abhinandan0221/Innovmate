...
const CTA = React.forwardRef<HTMLDivElement, CTAProps>(
  ...
  //                 asChild
  //                 size="lg"
  //                 className="bg-green-600 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-800 text-white font-medium"
  //               >
  ...
  //     </div>
  //   );
      <div className="bg-background border-t border-border" ref={ref}></div>
    );
  }
);
