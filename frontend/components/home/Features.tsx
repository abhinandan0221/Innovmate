    ...
    const getAccentColor = (accent: string) => {
      const colors = {
        green: {
          ...
          text: "text-green-700 dark:text-green-400 dark:group-hover:text-white",
          hover: "group-hover:bg-green-600 dark:group-hover:bg-green-800/40",
      ...
      return colors[accent as keyof typeof colors] || colors.green;
    };
    ...
    return (
      <div className="py-16 bg-background relative overflow-hidden" ref={ref}>
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            <div className="inline-flex items-center rounded-full bg-green-100 dark:bg-green-900/30 px-4 py-1.5 mb-4">
