    ...
    const pricingPlans = [
      {
        ...
        color:
          "bg-card border-border hover:border-green-200 dark:hover:border-green-400",
      ...
      },
      {
        ...
        cta: "Try Pro Free",
        color:
          "bg-gradient-to-b from-green-50 to-purple-50 dark:from-green-950/30 dark:to-purple-950/20 border-green-200 dark:border-green-400",
    ...
    return (
      <div className="py-10 bg-background" ref={ref}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <motion.div
              className="inline-flex items-center rounded-full bg-green-100 dark:bg-green-900/30 px-4 py-1.5 mb-4"
              initial={{ opacity: 0, y: 20 }}
              animate={
                pricingInView ? { opacity: 1, y: 0 } : { opacity: 0, y: 20 }
              }
              ...
              >
                {plan.popular && (
                  <div className="absolute top-0 right-6 transform -translate-y-1/2">
                    <div className="inline-flex bg-green-600 dark:bg-green-500 text-white text-xs font-medium px-3 py-1 rounded-full">
                      Most Popular
                    </div>
                  </div>
                )}
                <div className={`${plan.last ? "lg:pl-4" : "pl-0"}`}>
                  ...
                  <div
                    className={`mt-4 flex items-baseline text-foreground ${
                      plan.popular
                        ? ""
                        : "group-hover:text-green-700 dark:group-hover:text-green-400 transition-colors duration-200"
                    }`}
                  >
