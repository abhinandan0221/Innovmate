  ...
  ({ heroInView = true }, ref) => {
    ...
    const renderDashboardContent = () => {
      switch (currentView) {
        case "calendar":
          return (
            <div className="h-40 rounded-lg bg-green-50 dark:bg-green-900/20 p-3 overflow-hidden">
                    ...
                    <div
                      ...
                      className={`text-center py-1 px-0.5 rounded text-xs h-6 flex items-center justify-center ${
                        isToday
                          ...
                          : "text-foreground hover:bg-green-100 dark:hover:bg-green-800"
                      }`}
                    >
              ...
              <div className="space-y-2.5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
                    <div className="h-6 w-6 rounded-full bg-green-600 flex items-center justify-center mr-2">
        ...
        default:
          return (
            <div className="h-40 rounded-lg bg-green-50 dark:bg-green-900/20 p-4">
              ...
              <div className="h-2 w-full bg-green-100 dark:bg-green-800/50 rounded-full mb-4">
                <motion.div
                ...
                <div className="flex items-center relative">
                  ...
                  >
                    {completedTasks[2] ? (
                      ...
                      <div className="h-4 w-4 border-2 border-green-300 dark:border-green-600 rounded-full mr-2"></div>
                    )}
                  </motion.div>
                  <span className="text-sm text-muted-foreground">
                    Development{" "}
    ...
    return (
      <div
        className="bg-gradient-to-br from-green-50 via-background to-purple-50 dark:from-green-950/30 dark:via-background dark:to-purple-950/20"
        ref={ref}
      >
        <div
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <motion.div
                className="inline-flex items-center rounded-full bg-green-100 dark:bg-green-900/30 px-4 py-1.5 mb-6"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.6, delay: 0.1 }}
              >
                <span className="text-green-900 dark:text-green-300 text-sm font-medium flex items-center">
                  <Zap className="h-4 w-4 mr-1.5" /> Introducing InnovMate
                </span>
              </motion.div>
              <motion.h1
              ...
              >
                ...
                <span className="bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-purple-600 dark:from-green-500 dark:to-purple-400">
                  Projects
                </span>
              </motion.h1>
              <motion.p
                ...
                {isAuthenticated ? (
                  <>
                    <Button
                      asChild
                      size="lg"
                      className="bg-green-600 hover:bg-green-900 dark:bg-green-600 dark:hover:bg-green-600 text-white font-medium px-8 py-6 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
                    >
                      <Link href="/dashboard">
            ...
            >
              <div className="relative w-full max-w-lg">
                <motion.div
                  className="absolute -inset-0.5 rounded-2xl bg-gradient-to-r from-green-700 to-purple-600 opacity-30 blur-xl dark:from-green-700/20 dark:to-purple-600/20"
                  animate={{
                    scale: [1, 1.02, 1],
                    opacity: [0.2, 0.3, 0.2],
                  }}
                ...
                <div className="relative rounded-2xl bg-card dark:bg-card/90 p-6 shadow-2xl backdrop-blur-sm overflow-hidden">
                  <AnimatePresence>
                    {showCursor && isDesktop && (
                      ...
                      >
                        <MousePointer
                          className={`h-5 w-5 text-green-700 dark:text-green-200 drop-shadow-lg rotate-6 ${
                            currentStep === 0 ||
                            currentStep === 2 ||
                            currentStep === 4 ||
                            currentStep === 6
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <motion.div
                        className={`h-24 rounded-lg flex flex-col items-center justify-center p-2 transition-all cursor-pointer relative ${
                          activeCard === "calendar"
                            ? "bg-green-200 dark:bg-green-600/50 scale-105 shadow-lg"
                      ...
                      >
                        <CalendarIcon className="h-8 w-8 text-green-500 dark:text-green-400 mb-1" />
                        <span className="text-xs text-green-900 dark:text-green-300 font-medium">
                          Calendar
                        </span>
                      </motion.div>
                      <motion.div
                      ...
                      >
                        <Users className="h-8 w-8 text-green-500 dark:text-green-400 mb-1" />
                        <span className="text-xs text-green-900 dark:text-green-300 font-medium">
                          Team
                        </span>
                      </motion.div>
                      ...
                      >
                        <FileText className="h-8 w-8 text-green-500 dark:text-green-400 mb-1" />
                        <span className="text-xs text-green-900 dark:text-green-300 font-medium">
                          Tasks
                        </span>
                      </motion.div>
                    ...
                    <div className="flex gap-2 justify-end">
                      ...
                      <Button
                        size="sm"
                        className="bg-green-600 dark:bg-green-600 text-white hover:bg-green-900 dark:hover:bg-green-600"
                      >
                        Add Task
                      </Button>
                    </div>
