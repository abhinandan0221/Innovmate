      ...
      <div className="container px-4 py-12 md:px-6 md:py-16 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 lg:grid-cols-6">
          <div className="flex flex-col gap-6 md:col-span-2">
            <Link href="/" className="flex items-center gap-2 w-fit">
              <motion.div
                className="h-10 w-10 rounded-full bg-green-600 dark:bg-green-600 flex items-center justify-center"
              ...
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-600 to-purple-600 dark:from-green-500 dark:to-purple-400">
                InnovMate
              </span>
            </Link>
            ...
            <div className="flex gap-4">
              {!srv && locationLoaded && (
                ...
                >
                  <Link
                    href="https://github.com/atkonisberg"
                    className="text-muted-foreground hover:text-green-600 dark:hover:text-green-400 transition-colors p-2 rounded-full"
                  >
              ...
              {!srv && locationLoaded && (
                ...
                >
                  <Link
                    href="https://www.linkedin.com/in/atkonisberg/"
                    className="text-muted-foreground hover:text-green-600 dark:hover:text-green-400 transition-colors p-2 rounded-full"
                  >
              ...
              >
                <Link
                  href={`${(srv) ? "mailto:InnovMate@konisberg.studio" : "mailto:konisberg@student.agh.edu.pl"}`}
                  className="text-muted-foreground hover:text-green-600 dark:hover:text-green-400 transition-colors p-2 rounded-full"
                >
              ...
              {srv && (
                ...
                >
                  <Link
                    href="https://www.instagram.com/konisberg/"
                    className="text-muted-foreground hover:text-green-600 dark:hover:text-green-400 transition-colors p-2 rounded-full"
                  >
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="space-y-3">
              <Link
                href="#"
                className="text-muted-foreground hover:text-green-600 dark:hover:text-green-400 transition-colors flex items-center group"
              >
                <span>Features</span>
        ...
        <div className="mt-12 border-t border-border pt-6">
          <p className="text-center text-sm text-muted-foreground">
            © {new Date().getFullYear()} InnovMate. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
