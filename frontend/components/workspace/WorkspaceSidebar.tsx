            ...
            <div className="flex flex-col h-full">
              <div className="border-b border-border/40 p-4 flex items-center justify-between">
                <Link href="/" className="flex items-center gap-2">
                  ...
                  <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-purple-600">
                    InnovMate
                  </span>
                </Link>
              </div>
                  ...
                  <DropdownMenuTrigger asChild>
                    ...
                    >
                      <Avatar className="h-8 w-8">
                        ...
                        />
                        <AvatarFallback className="bg-gradient-to-br from-green-500 to-indigo-700 text-white text-xs">
    ...
    <Sidebar className="hidden md:flex" collapsible="icon">
      ...
      >
        <Link href="/" className="flex items-center gap-2">
          ...
          <span className="text-lg font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-700 to-purple-600 transition-opacity duration-200 group-data-[collapsible=icon]:opacity-0 group-data-[collapsible=icon]:hidden">
            InnovMate
          </span>
        </Link>
        <Button
