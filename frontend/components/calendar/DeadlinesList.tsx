                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex justify-between items-center mt-2">
                                ...
                                <Button
                                  variant="ghost"
                                  size="sm"
                                  className="h-7 px-2 text-xs text-green-700 dark:text-green-400 ml-auto"
                                  asChild
                                >
                                  <Link
                                    href={
                        ...
                        <div className="flex items-start justify-between">
                            ...
                            <div>
                              ...
                              {deadline.type === "task" && (
                                <div className="text-sm text-muted-foreground mt-1">
                                  Project:{" "}
                                  <Link
                                    className="text-sm mt-1 text-green-600 dark:text-green-400 hover:underline"
                                    href={`/projects/${deadline.project.id}`}
                                  >
                                    {deadline.project.name}
                                  </Link>
                          ...
                          <div className="flex flex-col items-end gap-2">
                            ...
                            <Button
                              variant="ghost"
                              size="sm"
                              className="h-7 px-2 text-xs text-green-700 dark:text-green-400"
                              asChild
                            >
                              <Link
                                href={
