...
export default function CalendarView({
  ...
  const getDayClass = (day: Date) => {
    return cn(
      ...
      {
        "bg-green-50 dark:bg-green-950/20": isToday(day),
              ...
              {isMobile ? (
                <>
                  ...
                  {getEventsForDay(day).length > 0 && (
                    <div className="absolute bottom-0 w-full flex justify-center">
                      <div className="h-1.5 w-1.5 bg-green-500 rounded-full mb-0.5"></div>
                    </div>
                  )}
                </>
              ) : (
                <>
                  <div className="flex justify-between">
                    ...
                    {isToday(day) && (
                      <Badge className="bg-green-500 hover:bg-green-600 h-4 px-1">
                        Today
                      </Badge>
                    )}
                  </div>
