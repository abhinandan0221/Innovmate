...
export default function ActivityFeed({ activities }: ActivityFeedProps) {
  ...
  const renderActivityIcon = (type: string) => {
    switch (type) {
      ...
      case "TASK_CREATED":
        return (
          <FileText className="h-4 w-4 mr-2 mt-0.5 flex-shrink-0 text-green-500 dark:text-green-400" />
        );
      case "TASK_UPDATED":
        return (
        ...
        return (
          <span>
            ...
            <Link
              ...
              className="text-green-700 hover:underline font-medium dark:text-green-400"
            >
