...
export function WelcomeBanner({
  ...
  return (
    <motion.div
      className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-green-600 to-green-800 p-8 text-white shadow-lg"
      ...
      <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
        ...
        <motion.div variants={itemVariants} className="flex flex-wrap gap-3">
          ...
          <Link href="/projects/create">
            <Button
              size="sm"
              className="rounded-full bg-white text-green-800 hover:bg-white/90 cursor-pointer"
            >
