...
export default function DashboardStats({ stats }: StatsProps) {
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
      <Link href="/projects">
        <Card className="bg-gradient-to-br from-green-50 to-purple-50 dark:from-green-950/40 dark:to-purple-950/40 border-green-100 dark:border-green-900/50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              <div className="rounded-full bg-green-100 dark:bg-green-900/50 p-2">
                <LayoutGrid className="h-5 w-5 text-green-700 dark:text-green-400" />
              </div>
              <div>
