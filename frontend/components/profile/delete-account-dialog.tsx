    ...
    >
      <DialogContent className="sm:max-w-md">
              ...
              <div className="space-y-2">
                ...
                <div className="flex gap-2">
                  <Input
                    ...
                    className="flex-1 border-input focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all"
                    maxLength={6}
                  />
                  <Button
                    onClick={verifyCode}
                ...
                <Button
                  ...
                  type="button"
                  variant="link"
                  className="h-auto p-0 text-xs text-muted-foreground hover:text-green-700 dark:hover:text-green-400"
                  disabled={isRequestingCode}
                >
        ...
        <DialogFooter className="flex gap-2 sm:justify-between sm:gap-0">
          ...
          <Button
            className="bg-green-600 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 text-white transition-all"
