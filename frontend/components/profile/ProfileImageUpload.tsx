    ...
    return (
      <div className="relative">
        ...
        >
          ...
          />
          <AvatarFallback
            className={`${fallbackTextSize} bg-gradient-to-br from-green-500 to-indigo-700 text-white`}
          >
                ...
                <div className="p-4 bg-red-50 rounded-lg text-center">
                  ...
                  <div className="flex space-x-4 justify-center">
                    ...
                    <Button
                      ...
                      size="sm"
                      className="flex items-center bg-green-600 hover:bg-red-700 px-4"
                    >
                      Remove
                    </Button>
                  </div>
              ...
              <div className="flex flex-col items-center space-y-4">
                <div className="relative">
                  <img
                    ...
                    alt=""
                    className="w-40 h-40 object-cover rounded-full border-4 border-green-100"
                  />
                </div>
                <p className="text-sm text-center text-gray-600">
                  How does this look?
                ...
                <div className="flex space-x-4">
                  ...
                  <Button
                    ...
                    size="sm"
                    className="flex items-center bg-green-600 hover:bg-green-600 px-4"
                  >
              ...
              <div className="flex flex-col items-center space-y-6">
                ...
                <div className="w-full max-w-xs">
                  <UploadButton
                    ...
                    appearance={{
                      button:
                        "bg-green-600 hover:bg-green-600 text-white py-2 px-4 rounded-md font-medium w-full",
