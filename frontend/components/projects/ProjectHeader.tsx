...
import CollaborateDialog from "./CollaboratorDialog";
  ...
  return (
    <div className="w-full px-2 sm:px-4">
      <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:items-center md:justify-between">
        ...
        <div className="hidden md:flex md:flex-row gap-2">
          ...
          {(isAdmin || isEditor) && (
            <Button
              asChild
              className="bg-green-600 hover:bg-green-800 text-white flex items-center"
              size="sm"
            >
        ...
        <div className="flex md:hidden justify-between gap-2">
          ...
          {(isAdmin || isEditor) && (
            <Button
              asChild
              className="flex-1 bg-green-600 hover:bg-green-800 text-white flex items-center justify-center"
              size="sm"
            >
              <Link href={`/tasks/create?projectId=${project.id}`}>
      ...
      <CollaborateDialog
        ...
        onOpenChange={setIsCollaborateDialogOpen}
        onProjectUpdated={onProjectUpdated}
      />
    </div>
  );
