          ...
          <div className="flex justify-end gap-3 mt-4">
            ...
            {projectFiles.length <= 4 && (
              <Button
                ...
                className="bg-green-600 hover:bg-green-600 text-white cursor-pointer"
              >
                {isUploading ? (
                  <>
          ...
          <AlertDialogFooter className="sm:flex-row flex-col gap-2 sm:gap-0">
            <div className="flex gap-2">
              ...
              <Button
                ...
                disabled={isDeleting}
                className="bg-green-600/80 hover:bg-red-700 text-white cursor-pointer flex items-center justify-center"
              >
                {isDeleting ? (
