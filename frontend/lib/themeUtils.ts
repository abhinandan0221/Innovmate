...
export function getStoredTheme(): string | null {
  ...
  return localStorage.getItem("InnovMate-theme");
}
...
export function setStoredTheme(theme: string): void {
  if (!isClient) return;
  localStorage.setItem("InnovMate-theme", theme);
}
...
export const themeColors = {
  ...
  // Accent colors
  greenPrimary: "bg-green-600 dark:bg-green-600",
  greenSecondary: "bg-green-100 dark:bg-green-900/30",
