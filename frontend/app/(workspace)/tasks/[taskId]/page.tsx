          ...
          <div>
            {isEditing ? (
              <div className="w-full max-w-md">
                <Input
                  ...
                  className={cn(
                    "text-xl font-bold border-green-400 focus-visible:ring-green-400",
            ...
            <div className="flex items-center gap-2 text-sm opacity-80">
              <Link
                ...
                className="hover:text-green-800  dark:hover:text-green-300  hover:underline"
              >
                {project.name}
              </Link>
              <span>•</span>
          ...
          {isEditing && (
            <>
              ...
              <Button
                variant="default"
                size="sm"
                className="flex items-center bg-green-600 hover:bg-green-600 dark:bg-green-800 dark:hover:bg-green-900 text-white"
