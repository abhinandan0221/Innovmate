      ...
      <div className="mb-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          <div className="flex items-center space-x-2">
            <Badge
              variant="outline"
              className="px-3 py-1 border-green-200 bg-green-50 text-green-700 dark:border-green-800 dark:bg-green-900/30 dark:text-green-400"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="pt-4">
                ...
                <div className="flex flex-col sm:flex-row sm:justify-between gap-3">
                  ...
                  <Button
                    type="submit"
                    className="bg-green-600 hover:bg-green-600 dark:bg-green-600 dark:hover:bg-green-600 text-white order-1 sm:order-2"
