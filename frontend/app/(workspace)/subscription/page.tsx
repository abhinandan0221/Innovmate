                    ...
                    <Card className="flex flex-col">
                      <CardContent className="p-4 sm:p-4 flex flex-col flex-1">
                        <div className="flex items-center justify-between mb-4 sm:mb-3">
                          <div className="flex items-center gap-3">
                            <Crown className="h-5 w-5 sm:h-5 sm:w-5 text-green-600" />
                            <h3 className="font-semibold text-base sm:text-base">Pro Plan</h3>
                          </div>
                          <Badge variant="outline" className="text-green-600 text-sm sm:text-sm px-3 py-1">
                            $29/month
                          </Badge>
                        </div>
                  ...
                  <Card className="flex flex-col">
                    <CardContent className="p-4 flex flex-col flex-1">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <Badge variant="outline" className="text-green-600 text-sm px-3 py-1">
                          $29/month
                        </Badge>
                      </div>
